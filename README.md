...
Likewise, **TestReceiver** has 2 python scripts (and a .bat that launches both) that simulate HTTP services that receive the data from JunctionRelay, over ports 5000 and 5005. Add 'Generic HTTP Sender' as the data target and enter URL of http://localhost:5000/data.json (change port as needed)
