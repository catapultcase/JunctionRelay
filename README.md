...
## Visual HUD Designer for Connected Devices
...
## Primary Focus: FrameEngine HUD Designer
...
* **Visual Layout Editor** – Drag-and-drop interface builder for creating custom HUDs
...
JunctionRelay serves as a central hub for connected hardware: sensors, microcontrollers, and display screens. At its core is the FrameEngine - a visual HUD designer that transforms how you build interfaces for embedded displays. Design sophisticated dashboards in your browser, then deploy them instantly to ESP32 devices running on everything from tiny 1.14" screens to large touch panels.
...
* **FrameEngine Visual Designer** – Browser-based HUD creation tool with real-time preview
...
* **Component Library** – A growing collection of pre-built HUD widgets and controls
...
1. **Design** – Use the FrameEngine to build your HUD in the browser
