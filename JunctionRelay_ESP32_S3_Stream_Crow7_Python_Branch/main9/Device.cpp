...
Device_CrowPanel7::CustomLGFX::CustomLGFX() {
    {
        ...
        cfg.offset_x = 0;
        cfg.offset_y = 0;
        // Note: Panel is wired in BGR order, LovyanGFX will handle RGB->BGR conversion
...

    {
        ...
        // RGB pins - CrowPanel7 specific pin configuration (BGR order)
...
Device_CrowPanel7::Device_CrowPanel7(void* unused)
: rotation(0) {
    // Simplified constructor for POC (no connection manager or touch needed)
}
