...
public:
    ...
    // Pure virtual method for hardware initialization
    ...
    // --- Display Access ---
    // Return generic display pointer (can be cast to device-specific type)
    virtual void* getDisplay() {
        // Default implementation returns nullptr for devices without displays
        return nullptr;
    }
    ...
    // Simple rotation logic for all devices (no LVGL dependencies)
    void rotateDisplay() {
        ...
        Serial.printf("[DEVICE] Display rotated to: %d\n", newRotation);
    }
};
