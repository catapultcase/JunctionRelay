...
class ScreenRouter;
class DeviceConfig;
class Display_Manager_Native;
class Display_Manager_Blit;
...
public:
    ...
    Display_Manager_Native* getDisplayManager() const { return displayManager; }
    Display_Manager_Blit* getBlitManager() const { return blitManager; }
...
private:
    ...
    Display_Manager_Native* displayManager;
    Display_Manager_Blit* blitManager;
