    ...
    if (doc.containsKey("action")) {
        ...
        if (action == "get") {
            ...
            if (data.containsKey("connMode")) {
                ...
                Serial.printf("[Branch_Ethernet] Connection mode updated to: %s\n", connMode.c_str());
            }
            ...
            if (data.containsKey("rotation")) {
                ...
                Serial.printf("[Branch_Ethernet] Display rotation updated to: %d\n", rotation);
            }
            ...
            if (data.containsKey("swapBlueGreen")) {
                ...
                Serial.printf("[Branch_Ethernet] Swap B/G channels set to: %s\n", swapBG ? "true" : "false");
            }
            ...
            if (data.containsKey("mqttPassword")) {
                ...
                if (mqttPassword.length() > 0) {
                    ...
                    Serial.println("[Branch_Ethernet] MQTT password updated");
                } else {
                    Serial.println("[Branch_Ethernet] Skipping empty MQTT password (keeping existing)");
                }
            }
            ...
            if (data.containsKey("externalNeoPixelsData1")) {
                ...
                Serial.printf("[Branch_Ethernet] External NeoPixels Data1 updated to: %s\n", neoPixel1.c_str());
            }
            ...
            if (data.containsKey("externalNeoPixelsData2")) {
                ...
                Serial.printf("[Branch_Ethernet] External NeoPixels Data2 updated to: %s\n", neoPixel2.c_str());
            }
            ...
            if (data.containsKey("restart") && data["restart"].as<bool>()) {
                Serial.println("[Branch_Ethernet] Restart requested, restarting device in 2 seconds...");
                delay(2000);
                ESP.restart();
            }
        }
