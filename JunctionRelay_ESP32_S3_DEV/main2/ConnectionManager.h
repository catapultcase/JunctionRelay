...
public:
    ...
    // Native USB CDC methods
    void handleNativeUSBData();
    void checkMemoryHealth(const char* location);
...
private:
    // Native USB CDC - Advanced USB handling
    ...
    // Compression and payload handling
    void decompressAndProcess(uint8_t* compressedData, size_t compressedLen);
