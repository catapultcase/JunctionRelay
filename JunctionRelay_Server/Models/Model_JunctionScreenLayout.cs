...
namespace JunctionRelayServer.Models
{
    public class Model_JunctionScreenLayout
    {
        ...
        public int? StreamingFps { get; set; } // Target FPS for MJPEG streaming mode (default: 30)
        public int? StreamingJpegQuality { get; set; } // JPEG quality for MJPEG streaming mode (1-100, default: 85)
    }
}
