...
namespace JunctionRelayServer.Controllers
{
    ...
    public class Controller_Junctions : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteJunction(int id)
        {
            ...
            if (_connectionManager.IsJunctionRunning(id))
            {
                return BadRequest(new { message = "Cannot delete a running junction. Please stop it first." });
            }
        ...
        // REMOVED: /api/junctions/{id}/stream endpoint
        // Streaming is now handled per-screen via /device/{virtualDeviceId}/stream
        // See Controller_VirtualStreams.cs for the proper implementation
    }
}