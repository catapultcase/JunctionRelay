...
namespace JunctionRelayServer.Controllers
{
    ...
    public class Controller_LoggingSettings : ControllerBase
    {
        ...
        private readonly Service_CloudBackupScheduler_Logger _cloudBackupLogger;
        ...
        public Controller_LoggingSettings(
            ...
            Service_CloudBackupScheduler_Logger cloudBackupLogger,
            Service_LogRotation_Manager logRotationManager)
        {
            ...
            _cloudBackupLogger = cloudBackupLogger;
        ...
        /// <summary>
        /// Gets cloud backup scheduler logging status and info
        /// </summary>
        [HttpGet("cloudbackup/status")]
        public IActionResult GetCloudBackupStatus()
        {
            var logFilePath = _cloudBackupLogger.GetLogFilePath();
            var logFileExists = System.IO.File.Exists(logFilePath);
            var logFileSizeBytes = logFileExists ? new System.IO.FileInfo(logFilePath).Length : 0;

            var status = new
            {
                IsEnabled = _cloudBackupLogger.IsEnabled(),
