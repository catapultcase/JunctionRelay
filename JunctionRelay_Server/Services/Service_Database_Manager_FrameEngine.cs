    ...
    public class Service_Database_Manager_FrameEngine
    {
        ...
        INSERT INTO FrameLayouts
          (DisplayName, Description, LayoutType,
           IsTemplate, CloudTemplateId, CloudVariantId, IsDraft, IsPublished, IsStandalone, Created, LastModified, CreatedBy, Version,
           BackgroundType, BackgroundColor, BackgroundImageUrl, BackgroundImageFit, BackgroundVideoUrl,
           BackgroundVideoFit, VideoLoop, VideoMuted, VideoAutoplay, BackgroundLoopCompensation, BackgroundLoopCutoverMs, BackgroundLoopCrossfadeMs, BackgroundOpacity,
    ...
    ";
        ...
        public async Task<bool> UpdateFrameLayoutAsync(Model_Frame_Layout frameLayout)
        {
            ...
            const string sql = @"
                ...
                SET
                  ...
                  BackgroundLoopCompensation = @BackgroundLoopCompensation,
                  BackgroundLoopCutoverMs = @BackgroundLoopCutoverMs,
                  BackgroundLoopCrossfadeMs = @BackgroundLoopCrossfadeMs,
        ...
        public async Task<int> CloneFrameLayoutAsync(int originalId, string? newName = null)
        {
            ...
            var clone = new Model_Frame_Layout
            {
                ...
                BackgroundLoopCompensation = original.BackgroundLoopCompensation,
                BackgroundLoopCutoverMs = original.BackgroundLoopCutoverMs,
                BackgroundLoopCrossfadeMs = original.BackgroundLoopCrossfadeMs,
    ...
    bool preserveCloudIds = true)
        {
            ...
            bool? backgroundLoopCompensation = null;
            if (importData.TryGetProperty("backgroundLoopCompensation", out var loopCompensationProp))
            {
                backgroundLoopCompensation = loopCompensationProp.GetBoolean();
            }

            int? backgroundLoopCutoverMs = null;
            if (importData.TryGetProperty("backgroundLoopCutoverMs", out var loopCutoverProp))
            {
                backgroundLoopCutoverMs = loopCutoverProp.GetInt32();
            }

            int? backgroundLoopCrossfadeMs = null;
            if (importData.TryGetProperty("backgroundLoopCrossfadeMs", out var loopCrossfadeProp))
            {
                backgroundLoopCrossfadeMs = loopCrossfadeProp.GetInt32();
            }
