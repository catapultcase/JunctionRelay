    ...
    public class Service_Settings : IService_Settings, IDisposable
    {
        ...
        private async Task InitializeCacheAsync()
        {
            ...
            try
            {
                ...
                var allSettings = await _db.QueryAsync<Model_Setting>("SELECT * FROM Settings");
        ...
        public async Task<Dictionary<string, string>> GetAllSettingsAsync()
        {
            ...
            try
            {
                ...
                var allDbSettings = await _db.QueryAsync<Model_Setting>("SELECT * FROM Settings");
        ...
        private async Task DeleteSettingFromDatabaseAsync(string key)
        {
            try
            {
                var rowsAffected = await _db.ExecuteAsync("DELETE FROM Settings WHERE Key = @Key", new { Key = key });
