    ...
    public class Service_Database_Initializer
    {
        ...
        public async Task SeedInitialSettingsAsync()
        {
            ...
            var defaultSettings = new List<(string Key, string Value, string Description)>
            {
                ...
                ("use_frameengine2", "true", "If true, use the new FrameEngine2 editor instead of the legacy ConfigureFrame"),
                ("use_virtualscreenviewer2", "true", "If true, use the new VirtualScreenViewer2 instead of the legacy VirtualScreenViewer"),
