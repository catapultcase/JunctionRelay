...
export const defaultDeviceColumns: DeviceColumn[] = [
    ...
    { field: "uniqueIdentifier", label: "Unique ID", align: "left", sortable: true },
    { field: "status", label: "Status", align: "left", sortable: true },
    { field: "connMode", label: "Connection", align: "left", sortable: true },
    { field: "firmware", label: "Firmware", align: "left", sortable: true },
    { field: "custom", label: "Custom", align: "left", sortable: true },
    { field: "heartbeatStatus", label: "Heartbeat", align: "left", sortable: true },
    { field: "heartbeatProtocol", label: "HB Protocol", align: "left", sortable: true },
    { field: "lastPinged", label: "Last Pinged", align: "left", sortable: true },
    { field: "pingLatency", label: "Ping (ms)", align: "right", sortable: true },
    { field: "consecutiveFailures", label: "Failures", align: "right", sortable: true },
