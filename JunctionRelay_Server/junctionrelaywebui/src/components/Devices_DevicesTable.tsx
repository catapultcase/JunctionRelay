...
const DeviceCard = memo(({
    ...
    const renderCard = (deviceData: any, deviceLevel: number) => (
        <Card
            ...
            onClick={isScanResults ? (handleCardClick ? () => handleCardClick(deviceData) : undefined) : () => {
                if (deviceData.type === "VirtualDevice" || deviceData.isVirtualDevice) {
                    navigate(`/virtualdevices/${deviceData.id}/configure`);
                } else {
        ...
        rows.push(
            <TableRow
                ...
                onClick={isScanResults ? (handleCardClick ? (e) => {
                    ...
                    if (device.type === "VirtualDevice" || device.isVirtualDevice) {
