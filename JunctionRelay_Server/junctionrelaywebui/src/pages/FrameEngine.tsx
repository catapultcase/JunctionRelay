...
import { preloadCommonFonts } from '@junctionrelay/frameengine2';
...
const AddFrameLayoutModal: React.FC<{
    ...
    const frameLayoutTypes = [
        { value: "COMPOSITE_MODE", name: "Composite Mode", desc: "Multi-layer composition with elements and backgrounds (default: 800x600px)" },
        { value: "PIXEL_MODE", name: "Pixel Mode", desc: "Pixel art displays with grid snapping (default: 64x64px, max: 256x256px)" }
    ];
    ...
    const handleTypeChange = (e: SelectChangeEvent<string>) => {
        ...
        const typeInfo = frameLayoutTypes.find(t => t.value === selectedType);

        // Set default name and description based on layout type
        setFrameLayout({
            ...frameLayout,
                ...
                {loading ? (
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            {frameLayoutTypes.map((layoutType) => (
                                <Box
                                    key={layoutType.value}
                                    onClick={() => setFrameLayout({
                                        ...frameLayout,
                                        layoutType: layoutType.value,
                                        displayName: layoutType.name,
                                        description: layoutType.desc
                                    })}
                                    sx={{
                                        p: 2,
                                        mx: 1,
