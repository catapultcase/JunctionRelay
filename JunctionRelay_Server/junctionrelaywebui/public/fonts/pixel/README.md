# Pixel Fonts for FrameEngine

This directory contains pixel-perfect bitmap fonts for use in JunctionRelay's FrameEngine text elements.
...
## Usage in FrameEngine

These fonts are automatically loaded by `FrameEngine_FontLoader.ts` when a text element uses `fontType: 'pixel'`.
