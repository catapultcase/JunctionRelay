...
public:
    ...
    // Matrix B/G channel swap (for RGB Matrix displays)
    bool    getSwapBlueGreen();
    void    setSwapBlueGreen(bool swap);

    // External NeoPixel pin configuration
    String  getExternalNeoPixelsData1();
    void    setExternalNeoPixelsData1(const String &pin);

    String  getExternalNeoPixelsData2();
    void    setExternalNeoPixelsData2(const String &pin);
...
private:
    ...
    static constexpr const char* KEY_SWAP_BG    = "swapBG";
    static constexpr const char* KEY_NEOPIXEL1  = "neoPixel1";
    static constexpr const char* KEY_NEOPIXEL2  = "neoPixel2";
