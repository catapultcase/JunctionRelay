...
#define DEVICE_ADAFRUIT_SPARKLE_MOTION_MINI
...
#define DEVICE_MODEL                    "SparkleMotion Mini ESP32"
...
#define DEVICE_WIRELESS_CONNECTIVITY    "2.4 GHz Wi-Fi & Bluetooth 4.2"
...
#define DEVICE_IS_GATEWAY               0
    ...
    #define DEFAULT_EXTERNAL_PIN_1 32
    #define DEFAULT_EXTERNAL_PIN_2 33
...
class Device_AdafruitSparkleMotionMiniESP32S3 : public DeviceConfig {
public:
...
typedef Device_AdafruitSparkleMotionMiniESP32S3 Device;
