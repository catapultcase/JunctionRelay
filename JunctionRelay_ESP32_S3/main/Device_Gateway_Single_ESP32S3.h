#ifndef DEVICE_GATEWAY_SINGLE_ESP32S3_H
#define DEVICE_GATEWAY_SINGLE_ESP32S3_H
...
#define DEVICE_SUPPORTS_WIFI     0  // Disabled for Scenario 1 (USB communication to host)
#define DEVICE_SUPPORTS_ESPNOW   1  // Enabled for ESP-NOW communication with peers
#define DEVICE_SUPPORTS_BLE      0
#define DEVICE_HAS_SPEAKER       0
#define DEVICE_HAS_MICROSD       0
#define DEVICE_SUPPORTS_USB      1  // Enabled for USB communication to host
...
class Device_Gateway_Single_ESP32S3 : public DeviceConfig {
public:
    Device_Gateway_Single_ESP32S3();  // Constructor
...
#endif // DEVICE_GATEWAY_SINGLE_ESP32S3_H
